...
+ (void)drawCameraShutterWithFrame: (CGRect)frame
{
    ...
    //// Page-1
    {
        //// Portrait
        {
            ...
            [aPath moveToPoint : CGPointMake(page1.size.width/2 + page1.origin.x , page1.origin.y)];
            [aPath addLineToPoint:CGPointMake(page1.origin.x + page1.size.width , page1.origin.y + page1.size.height/2)];
            [aPath addLineToPoint:CGPointMake(page1.origin.x + page1.size.width/2, page1.size.height + page1.origin.y)];
            [aPath addLineToPoint:CGPointMake(page1.origin.x , page1.origin.y + page1.size.height/2)];
            [aPath closePath];
            
            
            UIBezierPath* cameraShutterVectorPath = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(page1) + floor(CGRectGetWidth(page1) * 0.00000 + 0.5), CGRectGetMinY(page1) + floor(CGRectGetHeight(page1) * 0.00000 + 0.5), floor(CGRectGetWidth(page1) * 1.00000 + 0.5) - floor(CGRectGetWidth(page1) * 0.00000 + 0.5), floor(CGRectGetHeight(page1) * 1.00000 + 0.5) - floor(CGRectGetHeight(page1) * 0.00000 + 0.5))];
            [cameraShutterVectorPath applyTransform:CGAffineTransformMake(0, 0, 0, 0, 0, 0)];
           
            // alert: code redundancy, to be used in future, For now, pack like so:
            cameraShutterVectorPath = aPath;
...
+ (void)drawCameraFlashWithFrame: (CGRect)frame
{
    ...
    //// Color Declarations
    UIColor* color = [UIColor colorWithRed: 161.0/255.0 green: 67.0/255.0 blue: 82.0/255.0 alpha: 1];
...
+ (void)drawCameraToggleWithFrame: (CGRect)frame
{
    ...
    //// Color Declarations
    UIColor* color2 = [UIColor colorWithRed: 161.0/255.0 green: 67.0/255.0 blue: 82.0/255.0 alpha: 1];
